...
;;;  all leaves of the second string would have index values <= (n1 + n2) etc.."
...
(defun list-rep-str-detailed (tree)
  ...
  (labels ((trv-tree (tree new-suf-str)		; helper function
    ...
    (when tree
      ...
      ;; remove duplications and ceck the length of the resulting list
	  ;; if length equal to number of trees, then keed such suffix, otherwise reject.
